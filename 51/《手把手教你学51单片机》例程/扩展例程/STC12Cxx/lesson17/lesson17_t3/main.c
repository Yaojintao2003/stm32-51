...
*
* 文件名：main.c
* 描  述：第17章 作业题3 可调频率的信号发生器
* 版本号：v1.0.0
* 备  注：针对STC12系列单片机修改定时器中断延时补偿参数
* 1、在lesson17_3基础上，改为由回车键切换不同波形，由上下键增减频率
* 2、频率可调范围限定在2～25Hz，因受限于PCF8591访问速度而无法做到很高
*******************************************************************************
*/
